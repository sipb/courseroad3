// TODO: see what can be done using
// panda css instead of manually settings everything
...
export const getRawColor = (courseColor?: string) => {
	if (courseColor && courseColor in colors) {
		return colors[courseColor as keyof typeof colors];
	}
...
export const courseColorFromId = (id: string) => {
	if (id !== undefined) {
